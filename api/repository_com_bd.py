...
#Função para criação de um resumo de aluno usado na rota post
def criando_aluno():
        obj = request.json
...
#função para retornar todos os alunos cadastrados
...
#Função para atualizar um registro de aluno já existente identificado pelo ID
